...
img_list = glob(r'C:\Users\ehdgn\PycharmProjects\파이썬과 40개의 작품들\Chapter07. 게임 및 인공지능 프로그램 만들기\37. 인공지능 사과와 오렌지 구분하기\검증용사진\*.jpg')
img_list.extend(glob(r'C:\Users\ehdgn\PycharmProjects\파이썬과 40개의 작품들\Chapter07. 게임 및 인공지능 프로그램 만들기\37. 인공지능 사과와 오렌지 구분하기\검증용사진\*.png'))
